...
# Streamlit 앱을 src 폴더 외부에서 실행할 때 모듈을 찾을 수 있도록 프로젝트 루트를 sys.path에 추가합니다.
# 이렇게 하면 `from src.core...`와 같은 절대 경로 임포트가 가능해집니다.
...
from src.core.calendar_api import get_calendar_events, create_calendar_event, exchange_code_for_token
from src.database.db_manager import update_event_history, get_auth_token
